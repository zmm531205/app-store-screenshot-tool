...
export const AppCard: React.FC<AppCardProps> = ({ app, isLast = false, language }) => {
  return (
    <>
      <div className="flex items-center py-[11px] bg-white h-[115px]">
        ...
        <div className="flex items-start gap-[16px] flex-1">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="font-sans text-[22px] font-normal text-black leading-[26px] mb-[5px] w-[214px]">
              {app.name}
            </h3>
            <p className="font-sans text-[16px] font-normal text-ios-gray-600 leading-[20px] w-[210px] truncate">
              {app.subtitle}
            </p>
          </div>
        </div>
        <div className="relative w-[112px] h-[52px] mr-[25px] flex items-center justify-center">
          <div className="absolute w-[105px] h-[46px] bg-ios-gray-200 border border-gray-300 rounded-[22px]"></div>
